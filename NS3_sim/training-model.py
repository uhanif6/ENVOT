...
for i, file in enumerate(test_files):
    ...
    plt.xticks(angles[:-1], top_features_indices, color='grey', size=8)
...
joblib.dump(ensemble, "/home/uhanif/NS3/ns-3-dev/scratch/ensemble_model.pkl")
joblib.dump(scaler, "/home/uhanif/NS3/ns-3-dev/scratch/scaler.save")


# Optionally, save the number of features for verification
num_features = all_train_features.shape[1]
with open('/home/uhanif/NS3/ns-3-dev/scratch/num_features.txt', 'w') as f:
